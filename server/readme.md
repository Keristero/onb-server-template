...
|            | set a specific tile GID            | <pre>area_id<br>x<br>y<br>z<br>tile_gid<br>flip_h<br>flip_v<br>rotate<br></pre> |          |        |
...
|       | Sleep for x seconds | <pre>duration<br></pre> |                      |        |
