...
|         class          |                                 description                                 |                                                           arguments                                                           |                                                                                         handlers                                                                                          | output |
|------------------------|-----------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------|
| keyframe_detail_values | used by keyframe details, you can specify hardcoded values for the keyframe |                                                                                                                               | <pre>Animation<br>Animation Speed<br>X<br>Y<br>Z<br>ScaleX<br>ScaleY<br>Rotation<br>Direction<br>Sound Effect<br>Sound Effect Loop<br></pre>                                              |        |
