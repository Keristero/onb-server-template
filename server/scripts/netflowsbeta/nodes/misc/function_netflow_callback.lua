return {
    global_object = 'Net',
    description = 'if this node was reached from a call_function_netflow, this node will return all the values in its context back to the on_callback handler of the call_function_netflow',
